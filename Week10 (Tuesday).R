...
# Make decisions on whether to keep variables or not
attach(states)
...
# A probability plot if all points are close to line then
# we have met the normality assumption very well
...
# Examine the outliers to investigate issues
